...
export default function DeckCard({ name, numwhite = 0, numblack = 0, ...props }) {
  return (
    <div className="w-40" {...props}>
      <ButtonCard type="white" text={name} br="rounded-sm" style={{ boxShadow: '-8px 8px 4px 0 rgba(0,0,0, 50%)' }} />
